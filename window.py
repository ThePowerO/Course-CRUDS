...
def étudiants():
    ...
    bouton_update2 = Button(frame_détails, command=actualisér_étudiants, anchor=CENTER, text="Update".upper(), width=9, overrelief=RIDGE, font=("Ivy 7 bold"), bg=co6, fg=co1,)
